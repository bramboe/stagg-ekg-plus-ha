...
class FellowStaggTargetTemperature(NumberEntity):
    ...
    def __init__(self, coordinator: FellowStaggDataUpdateCoordinator) -> None:
        ...
        # Set min/max for Fahrenheit (40°C to 100°C)
        self._attr_native_min_value = 104  # 40°C equivalent
        self._attr_native_max_value = 212  # 100°C equivalent
    ...
    def native_value(self) -> float | None:
        ...
        # Coordinator always stores data in Fahrenheit now
        value = self.coordinator.data.get("target_temp")

        if value is not None:
            _LOGGER.debug("Target temperature read as: %s°F", value)
            return value
