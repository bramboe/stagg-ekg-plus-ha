...
class FellowStaggWaterHeater(WaterHeaterEntity):
    ...
    def current_temperature(self) -> float | None:
        ...
        # Safely retrieve current temperature
    ...
    def target_temperature(self) -> float | None:
        ...
        # Safely retrieve target temperature
        data = self.coordinator.data or {}
        value = data.get("target_temp")
    ...
    def current_operation(self) -> str | None:
        ...
        # Safely retrieve power state
        data = self.coordinator.data or {}
        value = "on" if data.get("power") else "off"
